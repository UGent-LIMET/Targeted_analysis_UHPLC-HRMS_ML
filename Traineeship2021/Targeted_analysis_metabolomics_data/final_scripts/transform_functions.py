...
# This script contains functions used for "transformations"
...
def df_to_png(META, file, path):
    ...
    for index, row in df_meta.iterrows():
        ...
        plt.clim(0, 5.75 * 10 ** 4)
        plt.axis('off')
        plt.savefig(path + "png/" + new_filename + "_" + metabolite_name + '.png')
        plt.close('all')
    # close files
